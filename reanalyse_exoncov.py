...
if __name__ == "__main__":
	...
	group.add_option("-b", default="/hpc/diaggen/software/production/Dx_tracks/Tracks/ENSEMBL_UCSC_merged_collapsed_sorted_v3_20bpflank.bed", dest="EXONCALLCOV_BED", help="EXONCALLCOV_BED")
	group.add_option("-g", default="/hpc/diaggen/software/production/Dx_tracks/Exoncov/gpanels.txt", dest="EXONCALLCOV_PANEL", help="EXONCALLCOV_PANEL")
	group.add_option("-p", default="/hpc/diaggen/software/production/Dx_tracks/Exoncov/Preferred_transcript_list.txt", dest="EXONCALLCOV_PREF", help="EXONCALLCOV_PREF")
	group.add_option("-n", default="/hpc/diaggen/software/production/Dx_tracks/Exoncov/NM_ENSEMBL_HGNC.txt", dest="EXONCALLCOV_ENS", help="EXONCALLCOV_ENS")
	...
	group.add_option("-i", default="off", dest="use_ini", action="store_false", help="use information from INI file: OFF [default] or ON")
        group.add_option("-f", default="/hpc/diaggen/software/production/Dx_tracks/", dest="Dx_tracks_folder", metavar="[STRING]", help="Dx_tracks_folder")
