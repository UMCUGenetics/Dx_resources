...
os.system("/data/diagnostiek/production/Dx_resources/get_stats_from_flagstat.pl >run_stats.txt")
...
Dx_resources_folder="/data/diagnostiek/production/Dx_resources/"
Dx_INI_folder="/data/diagnostiek/production/Dx_INI/"
Dx_tracks_folder="/data/diagnostiek/production/Dx_tracks/"
# Get GIT tag version
