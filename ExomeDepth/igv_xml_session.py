...
def make_family_igv_file(args, familyid, child, father, mother, statistic):
    ...
    substitute_dic = {
        ...
        "hc_ratio_child_track": f"{hc_ratio_child_file}_{statistic}_test",
        "hc_ratio_father_track": f"{hc_ratio_father_file}_{statistic}_test",
        "hc_ratio_mother_track": f"{hc_ratio_mother_file}_{statistic}_test",
