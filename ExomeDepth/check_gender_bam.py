...
def get_gender(bam, arguments):
    ...
    with pysam.AlignmentFile(bam, "rb") as bam_file:
        ...
        if (
            y_ratio_perc <= arguments.ratio_y_female and
            x_ratio_perc >= arguments.ratio_x_female
        ):
            ...
            y_ratio_perc >= arguments.ratio_y_male and
            x_ratio_perc <= arguments.ratio_x_male
        ):
