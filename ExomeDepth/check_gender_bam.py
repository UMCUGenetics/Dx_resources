...
if __name__ == "__main__":
    ...
    parser.add_argument('--gender_determination_locus_y', default=settings.gender_determination_locus_y, help='Coordinates for includes region on chromosome X (default = gender_determination_locus_y in settings.py)')
    parser.add_argument('--gender_determination_locus_x', default=settings.gender_determination_locus_x, help='Threshold for maximum allowed CNV calls (default = gender_determination_locus_x in settings.py)')
    parser.add_argument('--gender_determination_y_ratio_female', default=settings.gender_determination_y_ratio[0], type=float, help='Maximum Y ratio threshold females (default = gender_determination_y_ratio[0] in settings.py)')
    parser.add_argument('--gender_determination_y_ratio_male', default=settings.gender_determination_y_ratio[1], type=float, help='Minimum Y ratio threshold males (default = gender_determination_y_ratio[1] in settings.py)')
    parser.add_argument('--gender_determination_x_ratio_male', default=settings.gender_determination_x_ratio[0], type=float, help='Maximum X ratio threshold males (default = gender_determination_x_ratio[0] in settings.py)')
    parser.add_argument('--gender_determination_x_ratio_female', default=settings.gender_determination_x_ratio[1], type=float, help='Minimum X ratio threshold females (default = gender_determination_x_ratio[1] in settings.py)')
