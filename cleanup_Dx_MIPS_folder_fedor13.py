...
inputlist = ["Dx_resources", "Dx_INI", "Dx_tracks", "Dx_mips", "Dx_fingerprinting"]
folderlist = ["/data/diagnostiek/production/Dx_resources/",
              "/data/diagnostiek/production/Dx_INI/",
              "/data/diagnostiek/production/Dx_tracks/",
              "/data/diagnostiek/production/Dx_mips/",
              "/data/diagnostiek/production/Dx_fingerprinting/"]
