...
if __name__ == "__main__":
	...
	group.add_option("--sdf", default="/hpc/cog_bioinf/common_scripts/rtg-tools-3.6/Homo_sapiens.GRCh37.GATK.illumina.SDF", dest="SDF", help="SDF file [default /hpc/cog_bioinf/common_scripts/rtg-tools-3.6/Homo_sapiens.GRCh37.GATK.illumina.SDF ]")
