...
if __name__ == "__main__":
	...
	group.add_option("-c", default="/hpc/diaggen/data/databases/GIAB/NIST_v2.19/union13callableMQonlymerged_addcert_nouncert_excludesimplerep_excludesegdups_excludedecoy_excludeRepSeqSTRs_noCNVs_v2.19_2mindatasets_5minYesNoRatio_noMT.bed", dest="high_conf_bed", help="High confident BED GIAB file [default /hpc/diaggen/data/databases/GIAB/NIST_v2.19/union13callableMQonlymerged_addcert_nouncert_excludesimplerep_excludesegdups_excludedecoy_excludeRepSeqSTRs_noCNVs_v2.19_2mindatasets_5minYesNoRatio_noMT.bed]")
	group.add_option("-b", default="/hpc/diaggen/software/production/Dx_tracks/Tracks/ENSEMBL_UCSC_merged_collapsed_sorted_v3_20bpflank.bed", dest="target_bed", help="Target BED file [default /hpc/diaggen/software/production/Dx_tracks/Tracks/ENSEMBL_UCSC_merged_collapsed_sorted_v3_20bpflank.bed Use \"OFF\" to exclude target BED file use")
	...
	group.add_option("--snp", default="/hpc/diaggen/data/databases/GIAB/NIST_v2.19/SNP_GIAB12878_nist2.19_truth.vcf.gz", dest="giab_snp", help="GIAB SNP truth VCF [default /hpc/diaggen/data/databases/GIAB/NIST_v2.19/SNP_GIAB12878_nist2.19_truth.vcf.gz]")
	group.add_option("--indel", default="/hpc/diaggen/data/databases/GIAB/NIST_v2.19/INDELS_GIAB12878_nist2.19_truth.vcf.gz", dest="giab_indel", help="GIAB INDEL truth VCF [default /hpc/diaggen/data/databases/GIAB/NIST_v2.19/INDEL_GIAB12878_nist2.19_truth.vcf.gz]")
